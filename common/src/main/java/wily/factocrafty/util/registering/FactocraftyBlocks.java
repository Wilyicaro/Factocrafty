...
public enum FactocraftyBlocks implements IFactocraftyLazyRegister<Block> {
    RUBBER_LOG, RUBBER_WOOD, STRIPPED_RUBBER_LOG, STRIPPED_RUBBER_WOOD,RUBBER_LEAVES,RUBBER_PLANKS, RUBBER_SLAB,RUBBER_STAIRS,RUBBER_FENCE,RUBBER_FENCE_GATE,RUBBER_DOOR, RUBBER_TRAPDOOR,RUBBER_PRESSURE_PLATE,RUBBER_BUTTON,RUBBER_SIGN,RUBBER_WALL_SIGN,TREETAP,
    MACHINE_FRAME,ADVANCED_MACHINE_FRAME,IRON_FURNACE,ELECTRIC_FURNACE,MACERATOR,COMPRESSOR,EXTRACTOR,REFINER,
