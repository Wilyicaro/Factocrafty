...
public class FactocraftyMachineCategory<T extends Recipe<Container>> implements IRecipeCategory<T> {
    ...
    public FactocraftyMachineCategory(RecipeType<T> recipeType, IGuiHelper guiHelper) {
        this(recipeType,guiHelper, 139, 63);
    }
    public FactocraftyMachineCategory(ResourceLocation background, RecipeType<T> recipeType, IGuiHelper guiHelper, IFactoryDrawableType.DrawableProgress type){
        this(background,recipeType,guiHelper,type, 139, 63);
    }
    public FactocraftyMachineCategory(RecipeType<T> recipeType, IGuiHelper guiHelper, int width, int height) {
        this(BACKGROUND_LOCATION,recipeType,guiHelper, FactocraftyDrawables.MACHINE_PROGRESS, width, height);
    }


    public FactocraftyMachineCategory(ResourceLocation background, RecipeType<T> recipeType, IGuiHelper guiHelper, IFactoryDrawableType.DrawableProgress type, int width, int height) {
